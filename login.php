...
<div id = "login">
	<form method="post" action ="">
		<div class="container">
			<div class="top">
				<h1 id="title" class="hidden"><span id="logo">Software <span>Engineering</span></span></h1>
			</div>
	...
	<?php if(isset($response)){
		 echo '<script type="text/javascript">alert("Please add a valid username and password");</script>';
	}
	?>
</div>
</body>
